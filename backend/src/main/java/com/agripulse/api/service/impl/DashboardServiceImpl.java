...
public class DashboardServiceImpl
    ...
    public DashboardDTO getDashboard(UserId userId) {
        ...
        double avgCompatibility = allAnalyses.stream()
        ...
        return new DashboardDTO(totalAnalyses, soilsTracked, avgCompatibility, analyses.stream().map(DashboardAnalysisCardDTO::from).toList());
    }
}